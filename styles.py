...
div[data-baseweb="select"] > div {
    ...
    border-radius: 4px !important; color: #d1d4dc !important; font-size: 12px !important;
}
...
input[type="number"], input[type="text"], input[type="password"], input[type="email"] {
    background: #1e222d !important; border: 1px solid #2a2e39 !important;
    border-radius: 4px !important; color: #d1d4dc !important; font-size: 13px !important;
}
...
div[data-testid="metric-container"] div[data-testid="stMetricValue"] {
    font-family: 'JetBrains Mono', monospace; font-size: 18px !important; color: #d1d4dc !important;
}
...
.sec-header {
    font-size: 11px; font-weight: 500; color: #787b86;
    text-transform: uppercase; letter-spacing: 0.07em;
    padding: 6px 0; border-bottom: 1px solid #2a2e39; margin-bottom: 12px;
}
/* Stat chip */
.stat-chip {
