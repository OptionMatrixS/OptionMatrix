...
with st.sidebar:
    ...
    if st.button("🔄  Refresh Token", use_container_width=True, type="secondary", help="Re-authenticate with Fyers"):
    ...
    st.markdown('<div style="font-size:10px;color:#2a2e39;text-align:center;padding-top:20px;">Option Matrix v2.0 · Fyers</div>',
                unsafe_allow_html=True)
...
def gate(tool_key, render_fn):
    if st.session_state.role=="admin" or tool_key in st.session_state.approved_tools:
        ...
        <div style="text-align:center;padding:80px 20px;">
          ...
          <div style="font-size:14px;color:#787b86;margin-top:8px;">Contact admin to get access.</div>
